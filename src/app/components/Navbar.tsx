      ...
      <header className="w-full bg-[var(--color-navy)] shadow-sm sticky top-0 z-40">
        <nav className="max-w-7xl mx-auto px-6 py-4 flex items-center justify-between relative">
          <div className="flex items-center space-x-4">
            <Image src="/images/logo.png" alt="Logo Tech Template" width={50} height={32} />
            <div className="flex flex-col leading-tight">
              <span className="text-xs font-semibold tracking-wider text-[var(--color-cyan)] uppercase">Tech</span>
              <span className="text-2xl md:text-3xl font-extrabold tracking-widest text-white">Template</span>
            </div>
          </div>

          {/* Desktop nav */}
          <ul className="hidden md:flex space-x-6 font-medium text-white relative">
            <li className="hover:text-[var(--color-cyan)] transition-colors">
              <Link href="#">Accueil</Link>
            </li>
            <li
              className="hover:text-[var(--color-cyan)] relative transition-colors"
          ...
          <div className="hidden md:flex ml-6">
            <Link
              href="#"
              className="bg-[var(--color-cyan)] text-[var(--color-navy)] px-5 py-2 rounded-full text-sm font-semibold shadow-lg hover:bg-[var(--color-emerald)] hover:text-[var(--color-navy)] transition"
            >
          ...
          >
            ...
            >
              ...
              <rect y="16" width="36" height="4" rx="2" fill="var(--color-cyan)" />
              <rect y="24" width="36" height="4" rx="2" fill="var(--color-emerald)" />
            </svg>
          </button>
